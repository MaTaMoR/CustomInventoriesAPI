package me.matamor.custominventories.utils.nbt;
...
public abstract class NBTType<V, T extends NBTTag<V>> {
    ...
    public static final NBTType<Boolean, NBTTagBoolean> BOOLEAN = new NBTType<Boolean, NBTTagBoolean>(boolean.class, Boolean.class, "NBTTagByte", Reflections.getConstructor("{nms}.NBTTagByte", byte.class)) {
        ...
        private final Reflections.MethodInvoker GETTER = Reflections.getMethod("{nms}.NBTBase$NBTNumber", "f");
    ...
    public static final NBTType<List<NBTTag>, NBTTagList> LIST = new NBTType<List<NBTTag>, NBTTagList>(null, null, "NBTTagList", Reflections.getConstructor("{nms}.NBTTagList")) {
        ...
        private final Reflections.MethodInvoker ADD = Reflections.getMethod(Reflections.getClass("{nms}.NBTTagList"), "add", Reflections.getClass("{nms}.NBTBase"));
    ...
    private NBTType(Class<?> primitiveClass, Class<V> wrapperClass, String minecraftClass, Reflections.ConstructorInvoker constructor) {
